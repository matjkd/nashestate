<div class="grid_9" style=" margin-top:3px; margin-left:5px;">
...
<div class="grid_14" style="float:right; margin-top:3px; text-align:right;">
    ...
    <a href="<?=base_url()?>services_tenants">Services to Tenants</a> |
